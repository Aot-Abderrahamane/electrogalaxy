...
<div class="container-full">
    ...
    <section class="content">
        <div class="row">
            ...
            <!--   ------------ Ajouter la page sous-sous-sous-catégorie -------- -->
                        ...
                        <div class="table-responsive">
                            ...
                            <form method="post" action="{{ route('subsubcategory.update') }}">
                                ...
                                <div class="form-group">
                                    <h5>Choisir une catégorie <span class="text-danger">*</span></h5>
                                    <div class="controls">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select name="subcategory_id" class="form-control">
                                            <option value="" selected="" disabled="">Sélectionnez la sous-catégorie
                                            </option>
