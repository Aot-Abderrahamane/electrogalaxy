                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu animated flipInX">
                        <li class="user-body">
                            ...
                            <a class="dropdown-item" href="{{route('admin.change.password')}}"><i class="ti-shield
                                text-muted mr-2"></i> changer votre mot de pass</a>
                            <a class="dropdown-item" href="#"><i class="ti-settings text-muted mr-2"></i> Paramétres</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{route('admin.logout')}}"><i
                                    class="ti-lock text-muted mr-2"></i> Déconecter</a>
                        </li>
                    </ul>
                </li>
                <li>
