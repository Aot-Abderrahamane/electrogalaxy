                                ...
                                <div class="">
                                    <ul class="nav nav-checkout-progress list-unstyled">
                                        ...
                                        <li>
                                            ...
                                            <strong>Total : </strong> MAD{{ $cartTotal }}
                                            <hr>
...
var stripe = Stripe('pk_test_51L4o80JosVSgplIeAMG6y2CVczwXuBXSL7RXDdR8IAIYEjVbF2JSzag9FoG5Qjq82nJAufCISyJtbBdt5XhcGl8w007tPyqFtB');
