...
<body class="cnt-home">
    ...
    <script src="{{ asset('frontend/assets/js/wow.min.js') }}"> new WOW().init();</script>
 ...
 @endif 
    ...
    <!-- Ajouter au produit de panier modal -->
    <!-- Fin Ajouter au produit de panier modal -->
    ...
    <!--  /// la page Ajouter un souhait .... Fin  ////   -->
    <!-- /// Chargez les données de la liste de souhaits....Début -->
   ...
   $.each(response.carts, function(key,value){
       ...
       <input type="text" value="${value.qty}" min="1" max="100" disabled="" style="width:25px;" >  
        ...
        <button type="submit" class="btn btn-success btn-sm" id="${value.rowId}" onclick="cartIncrement(this.id)" >+</button>    
            ...
            <td class="col-md-2">
           <strong>MAD ${value.subtotal} </strong> 
           </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <ul class="list-group">
                                <li class="list-group-item">Prix ​​du produit: <strong class="text-danger"> MAD<span
                                ...
                                <li class="list-group-item">Stocker: <span class="badge badge-pill badge-success"
                        ...
                        <div class="col-md-4">
                            ...
                            <button type="submit" class="btn btn-primary mb-2" onclick="addToCart()">Ajouter au
                                panier</button>
                        </div><!-- // end col md -->
                    </div> <!-- // end row -->
                </div> <!-- // end modal Body -->
