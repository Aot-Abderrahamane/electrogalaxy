...
@section('title')
    {{ $product->product_name }} détails du produit
@endsection
    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                <li><a href="#">Home</a></li>
                @foreach ($breadproduct as $item)
                    <li class='active'>{{ $item->subcategory_name }}</li>
                @endforeach

                @foreach ($breadproduct1 as $item)
                                        ...
                                        <div class="col-sm-6">
                                            <div class="price-box">
                                                @if ($product->discount_price == null)
                                                    <span class="price">MAD{{ $product->selling_price }}</span>
                                                @else
                                                    <span class="price">MAD{{ $product->discount_price }}</span>
                                                    <span
                                                        class="price-strike">MAD{{ $product->selling_price }}</span>
                                                @endif
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @else
                                                <label class="info-title control-label">Choisir la couleur <span>
                                                    </span></label>
                                                <select class="form-control unicase-form-control selectpicker"
                                                    style="display: none;" id="color">
                                                    <option selected="" disabled="">--Choisir la couleur--
                                                    </option>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @else
                                                <label class="info-title control-label">Choisir la taille <span>
                                                    </span></label>
                                                <select class="form-control unicase-form-control selectpicker"
                                                    style="display: none;" id="size">
                                                    <option selected="" disabled="">--Choisir la taille--
                                                    </option>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
                                    ...
                                    <li><a data-toggle="tab" href="#review">Évaluation</a></li>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-info text-left">
                                            ...
                                            <div class="product-price">
                                                <span class="price">
                                                    MAD{{ $product->selling_price }} </span>
                                            </div><!-- /.product-price -->
                                            @else

                                            <div class="product-price">
                                                <span class="price">
                                                    MAD{{ $product->discount_price }} </span>
                                                <span class="price-before-discount">MAD {{ $product->selling_price
                                                    }}</span>
                                            </div><!-- /.product-price -->
                                            @endif
