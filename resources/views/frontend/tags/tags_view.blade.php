                ...
                <div class="clearfix filters-container m-t-10">
                    <div class="row">
                        ...
                        <div class="col col-sm-12 col-md-6">
                                    ...
                                    <div class="fld inline">
                                        <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                                            ...
                                            <ul role="menu" class="dropdown-menu">
                                                ...
                                                <li role="presentation"><a href="#">Prix: les plus bas en premier</a>
                                                </li>
                                                <li role="presentation"><a href="#">Prix: les plus élevé en premier</a>
                                                </li>
                                                <li role="presentation"><a href="#">Nom du produit: A à Z</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <!-- /.fld -->
                            ...
                            <!-- /.col -->
                            <div class="col col-sm-3 col-md-6 no-padding">
                                <div class="lbl-cnt"> <span class="lbl">Afficher</span>
                                    <div class="fld inline">
                                        <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                                            ...
                                            <div class="product">
                                                <div class="product-image">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="tag new"><span>nouvelle</span></div>
                                                        @else
                                                ...
                                                <div class="product-info text-left">
                                                    ...
                                                    @if ($product->discount_price == NULL)
                                                    <div class="product-price"> <span class="price"> DH {{
